...
def main():
    ...
    filter_mask_1 = functions.create_low_pass_filter(imag_gray.shape, cutoff_frequency1)
    filter_mask_2 = functions.create_low_pass_filter(imag_gray.shape, cutoff_frequency2)
